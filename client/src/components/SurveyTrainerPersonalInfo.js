...
function SurveyTrainerPersonalInfo() {
  return (
              ...
              >
                <ul>
                  <li className='is-active'>
                    <Link to='trainer-personal-info' aria-current='page'>
                      Personal Information
                    </Link>
                  </li>
                  <li>
                    <Link to='trainer-experience'>Your Experience</Link>
                  </li>
                </ul>
              </nav>
            </div>
                              ...
                              <label className='file-label'>
                                ...
                                <span className='file-cta'>
                                  ...
                                  <span className='file-label'>
                                    Please upload a copy of your certification
                                  </span>
                                </span>
                              </label>
                            </div>
