              ...
              <div className=''>
                <div className='content'>
                  <section className='section'>
                    <div className='field '>
                      <label className='label'>What is your Fitness Goal?</label>
                    ...
                    <div className='field'>
                      <label className='label'>
                        What do you expect from a personal trainer and/or any
                        information that wouold make your experience better?
                      </label>
                      <div className='control'>
                        <textarea
                          className='textarea  is-info'
